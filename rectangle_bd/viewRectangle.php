...
$MyManager = new RectangleManager();
    ...
    <form method="post" action="">
        <div class="form-group row">
            ...
            <div class="col-6 ml-2">
                <input type="text" class="form-control" name="longueur" value="<?= $longueur ?>" id="inputName"
                    placeholder="">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-6 ml-3">
                <input type="text" class="form-control" name="largeur" value="<?= $largeur ?>" id="inputName"
                    placeholder="">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <button type="submit" name="btn_submit" value="reinitialisation"
                    class="btn btn-secondary">Reinitialiser</button>
            </div>
        </div>
    </form>
</div>
<?php
$Rectangles = $MyManager->findAll();
if (isset($_GET['annule'])) {
    $MyManager->delete($_GET['id']);
    header('Location: index.php ');
}
if (isset($_GET['editId'])) {
    $MyManager->update($_GET['id']);
    header('Location: index.php ');
}
        ...
        <tr>
            ...
            <td>
                <div class="editColumn">
                    <button class="btn btn-danger delete" id=<?= $rectangle->getId() ?>>DELETE</button>
                    <button class="btn btn-success edit " id=<?= $rectangle->getId() ?>>EDIT</button>
                </div>
